...
const ExpForm = (props) => {
    ...
    const titleChange = (e) => {
        ...
        //what's the problem in this type - we depend on previous state bcz we can use only one state insted of this 4 state bcz to copy in the existing value and the overriding one value 

        // setUserInput((preState) => {
        //     return { ...preState, enteredTitle: e.target.value}
        // })

        //if we use this approch the snapshot will give you latest state info
    }
